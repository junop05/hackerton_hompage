...
function AppointmentPage({ onNavigate, theme }) {
  ...
  const doctors = [
    ...
    { id: 'p6', name: '구민호', title: '전문의', dept: ['internal'], specialty: '내과 전문의', career: '경력 14년' },
  ];
...
function MedicalTeamPage({ onNavigate, theme }) {
  ...
  const doctors = [
    ...
    { name: '최준락', title: '원장', dept: ['burn'], deptLabel: '외과', career: '경력 18년', edu: '순천향대학교 의과대학 졸업', train: '외과 전문의', awards: ['대한화상학회 학술상'], specialties: ['중증 화상 수술', '피부이식', '화상 재건'] },
    ...
    { name: '구민호', title: '전문의', dept: ['internal'], deptLabel: '내과', career: '경력 14년', edu: '충남대학교 의과대학 졸업', train: '내과 전문의', awards: [], specialties: ['소화기 질환', '통증 관리', '중환자 내과'] },
  ];
